---
agent: 'agent'
description: 'Systematic debugging workflow for the Next.js 15 + Prisma v7 + Supabase realtime stack. Diagnoses issues layer by layer using logs, DB inspection, and browser snapshots.'
tools: ['search/codebase', 'read/terminalLastCommand', 'supabase/*', 'playwright/*']
---
...
mcp_microsoft_pla_browser_navigate(url: 'http://localhost:3000/api/session')
mcp_microsoft_pla_browser_snapshot()
```
...
3. **RLS blocking** → `mcp_supabase_get_advisors(type: 'security')`
